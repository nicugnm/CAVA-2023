...
predictions_path_root = "rezultate-testare/"
...
# sorting
def sortare(path):
    fisier_order = open(path, 'r')
    lines_order = fisier_order.readlines()[0:2]
    pct_order = fisier_order.readlines()
    fisier_order.close()

    fisier_order_write = open(path, 'w')
